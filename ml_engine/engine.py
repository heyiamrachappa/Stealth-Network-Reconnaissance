...
class MLInferenceEngine:
    """
    Manages offline machine learning predictions for network security forensics.
    Loads standard scalers, feature list definitions, and pre-trained classifiers.
    """
    ...
    def _load_scaler(self) -> Optional[Any]:
        ...
        logger.warning("No pre-trained StandardScaler found. Inference will operate unscaled!")
        return None
